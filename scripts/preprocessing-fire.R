...
# Intersect MTBS files with California boundary
...
fire_size_distribution = data.frame(Timestep = 2017,
                                    TransitionGroupID = "Fire",
                                    MaximumArea = mtbs_perim2$MaxSize,
                                    RelativeAmount = mtbs_perim2$freq)
write_csv(fire_size_distribution, "data/size-distribution/size-distribution-fire.csv")





# Use the Landfire rasters to create age distribution
